...
export function DeliveryManReview({
  deliveryManId,
  orderId,
  onReviewSubmitted,
}: DeliveryManReviewProps) {
  ...
  const submitReview = useMutation({
    mutationFn: async (data: ReviewFormData) => {
      ...
      formData.append("delivery_man_id", deliveryManId.toString());
      formData.append("order_id", orderId.toString());
      formData.append("comment", data.comment);
      formData.append("rating", data.rating.toString());

      const response = await api.post("/delivery-man/reviews/submit", formData);
