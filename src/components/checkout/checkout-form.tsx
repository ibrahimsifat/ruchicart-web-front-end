...
import { MapPin, Plus, Edit2, Home, Building2, MapPinned, ShoppingBag, Search } from "lucide-react"
...
const savedAddresses = [
  {
    id: "1",
    type: "home",
    fullAddress: "4673 Sayyid Ash Shuhada, 7698, Al Amir Abdoulmajed District, Jeddah 22432, Saudi Arabia",
  ...
  },
  {
    id: "2",
    type: "office",
    fullAddress: "123 Business Center, King Abdullah Road, Jeddah 23456, Saudi Arabia",
    contactPerson: "John Doe",
    phone: "+966 558845503",
  },
]
...
export function CheckoutForm() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      paymentMethod: "",
      branch: "",
      deliveryFee: 0, // Added default value for deliveryFee
    },
  })
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="text-base font-medium">Delivery Addresses</h3>
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => {
                      ...
                      >
                        ...
                        <div className="flex-1 space-y-1">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-muted-foreground">({address.contactPerson})</span>
                          </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-4">
                    <FormLabel className="text-lg font-semibold">Select Nearby Branch</FormLabel>
        ...
        <OrderSummary items={[]} total={0} deliveryFee={form.watch("deliveryFee")} />

        <Button type="submit" className="w-full">
          {deliveryOption === "home" ? "Proceed to Payment" : "Confirm Take Away Order"}
        </Button>
      </form>
